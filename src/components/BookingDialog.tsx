...
import { sendBookingNotification, initEmailJS } from '@/utils/emailService';
...
const BookingDialog = ({ children, trigger = true }: BookingDialogProps) => {
  ...
  useEffect(() => {
    ...
    // You should replace 'your_user_id' with your actual EmailJS user ID
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const emailResult = await sendBookingNotification({
        ...formState,
        to_email: 'your-notification-email@example.com' // Replace with your email
      });
      ...
      if (emailResult.success) {
        ...
        toast({
          title: "Success!",
          description: "Your booking request has been sent. We'll contact you shortly.",
        });
      } else {
        toast({
